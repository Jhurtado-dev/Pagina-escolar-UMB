...
class PalletController {
    createPallet(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const user = yield database_1.default.query('CALL stp_C_pallet(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [req.body.travel, req.body.bill, req.body.license_plate, req.body.destination, req.body.name_driver, req.body.temperature, req.body.cleaning, req.body.arrangement, req.body.coments, req.body.id_plant, req.body.created_by]);
    ...
    getPallet(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const transport = yield database_1.default.query('CALL stp_GC_pallets(?)', [date]);
...
exports.default = palletController;
